    ...
    <>   
        <div className="flex items-center justify-center my-10">
          <div className="flex border-2 rounded bg-gray-800">
            <input type="text" value={searchQuery} onKeyDown={handleKeyPress} onChange={(e)=>setSearchQuery(e.target.value)} className="px-4 py-2 w-3/4 md:w-80 bg-gray-800 text-white placeholder-gray-400 focus:outline-none" placeholder="Search by game name...." />
