...
function Footer() {
  ...
  return (
    ...
    <div className='bg-[#202020] w-full'>
      <div className='py-5 mx-10 md:mx-20 flex justify-between'>
        <div className='text-white text-3xl'>
          <FontAwesomeIcon className='hover:text-[aqua] duration-300 hover:cursor-pointer mr-5' icon={faFacebook} />
          <FontAwesomeIcon className='hover:text-[aqua] duration-300 hover:cursor-pointer mr-5' icon={faTwitter} />
          <FontAwesomeIcon className='hover:text-[aqua] duration-300 hover:cursor-pointer' icon={faYoutube} />
        </div>
        <div className='text-white text-3xl'>
